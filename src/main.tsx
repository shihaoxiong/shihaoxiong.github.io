...
function App() {
  ...
  return <main>
    ...
    <section className="about" id="about"><div><p className="eyebrow">ABOUT ME</p><h2>在复杂世界里，<br />寻找清晰的路径。</h2></div><div className="about-copy"><p>你好，我是 Xiaodan。关注 Agent、产品与值得长期投入的事物。</p><p>这个空间不追求即时结论，更在意诚实地记录问题、判断和变化。</p><a className="text-link" href="mailto:hello@example.com">和我聊聊 <span>↗</span></a></div></section>
